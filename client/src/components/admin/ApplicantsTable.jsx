...
const ApplicantsTable = ({ applicants: initialApplicants }) => {
  ...
  const processedApplicants = React.useMemo(() => {
    ...
    if (filterType === "premium") {
      ...
      list = list.filter(item => item.aiScore !== undefined && item.aiScore < 50);
    }
          ...
          <div className="relative w-full max-w-xl bg-[#080C1E] border border-white/10 rounded-3xl overflow-hidden shadow-[0_0_80px_rgba(0,200,255,0.2)] animate-in fade-in zoom-in-95 duration-300">
            ...
            <div className="flex items-center justify-between p-5 border-b border-white/5">
              ...
              <button 
                ...
                className="p-1.5 hover:bg-white/5 text-muted-foreground hover:text-white rounded-xl transition-all"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start">
                  ...
                  <div className="flex-1 space-y-4 text-start w-full">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-medium text-muted-foreground leading-relaxed bg-[#050810]/40 p-3.5 border border-white/5 rounded-xl italic">
